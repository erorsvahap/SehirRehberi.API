...
namespace SehirRehberi.API.Controllers
{
    ...
    public class PhotosController : ControllerBase
    {
        ...
        public PhotosController(IAppRepository appRepository, IMapper mapper, IOptions<CloudinarySetting> cloudinaryConfig)
        {
        ...
        public ActionResult AddPhotoForCity(int cityId, [FromBody] PhotoForCreationDto photoForCreationDto)
        {
            ...
            if (file.Length>0)
            {
                ...
                {
                    var uplodaParams = new ImageUploadParams
                    {
                        File=new FileDescription(file.Name,stream)
                    };
                    uploadResult =_cloudinary.Upload(uplodaParams);
                }
            }
